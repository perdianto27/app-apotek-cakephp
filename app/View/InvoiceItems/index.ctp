        ...
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <h3 class="card-title">Invoice Item</h3>
                </div>
                <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 text-right">
                    <?php echo $this->Html->link('<i class="fa fa-plus-circle"></i> '.__('New'), array('controller' => 'invoiceItems', 'action' => 'add'),['escape'=>false,'class'=>'btn btn-sm btn-light m-r-sm']); ?>
                ...
                <div class="col-12">
                    <div class="card-body table-responsive">
                        <div class="row m-b-sm m-t-sm">
                            <div class="col-md-12">
                                <?php echo $this->Form->create('InvoiceItem',array('type'=>'get','url'=>'index'));?>                                <div class="input-group mb-3">
                        ...
                        <?php if(count($invoiceItems)==0){?>                        <div class="text-center">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody><?php foreach ($invoiceItems as $invoiceItem): ?>
	 <tr>
		<td><?php echo h($invoiceItem['InvoiceItem']['id']); ?>&nbsp;</td>
		<td><?php echo h($invoiceItem['InvoiceItem']['price']); ?>&nbsp;</td>
		<td><?php echo h($invoiceItem['InvoiceItem']['qty']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions text-right">
			<?php echo $this->Html->link(__('<i class="fa fa-print"></i>'), array('action' => 'print_single', $invoiceItem['InvoiceItem']['id']),array('escape' => false,'title'=>'print','class'=>'print-btn btn btn-default btn-sm')); ?>
			<?php echo $this->Html->link(__('<i class="fa fa-eye"></i>'), array('action' => 'view', $invoiceItem['InvoiceItem']['id']),array('escape' => false,'title'=>'view details','class'=>'btn btn-default btn-sm')); ?>
			<?php echo $this->Html->link(__('<i class="fa fa-copy"></i>'), array('action' => 'copy', $invoiceItem['InvoiceItem']['id']),array('escape' => false,'title'=>'copy','class'=>'btn btn-default btn-sm')); ?>
			<?php echo $this->Html->link(__('<i class="fa fa-edit"></i>'), array('action' => 'edit', $invoiceItem['InvoiceItem']['id']),array('escape' => false,'title'=>'edit this record','class'=>'btn btn-default btn-sm')); ?>
			<?php echo $this->Form->postLink(__('<i class="fa fa-trash"></i>'), array('action' => 'delete', $invoiceItem['InvoiceItem']['id']),array('escape' => false,'title'=>'delete this record','class'=>'btn btn-default btn-sm'), __('Are you sure you want to delete # %s?', $invoiceItem['InvoiceItem']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</tbody>                            </table>
