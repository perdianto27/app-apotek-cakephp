...
$pdf->SetTitle("Clinic Report");
$pdf->SetSubject("Clinic");
$pdf->SetKeywords("Clinic");
...
$html.= '<center><h1>LAPORAN CLINIC</h1></center>';
$html.= '<table border="1" cellpadding="5" cellspacing="0" width="100%">';
    ...
    $html.= "<tr>";
                            $html.='<td>'.$clinic['Clinic']['id'].'</td>';
                                        $html.='<td>'.$clinic['Clinic']['name'].'</td>';
                                        $html.='<td>'.$clinic['Clinic']['adress'].'</td>';
                                        $html.='<td>'.$clinic['Clinic']['phone'].'</td>';
