...
$html="";
$title="Supplier";
$html.= '<center><h1>LAPORAN SUPPLIER</h1></center>';
$html.= '<table border="1" cellpadding="5" cellspacing="0" width="100%">';
                $html.= "<tr>";
                $html.= "<td>Id</td>";
                $html.='<td>'.$supplier['Supplier']['id'].'</td>';
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Name</td>";
                $html.='<td>'.$supplier['Supplier']['name'].'</td>';
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Address</td>";
                $html.='<td>'.$supplier['Supplier']['address'].'</td>';
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Phone</td>";
                $html.='<td>'.$supplier['Supplier']['phone'].'</td>';
                $html.= "</tr>";
                $html.= "</table>";
    $html.= '<p></p><p></p>';
