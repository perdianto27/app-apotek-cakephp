...
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor("Mizno Kruge");
$pdf->SetTitle("Sale Item Report");
$pdf->SetSubject("Sale Item");
$pdf->SetKeywords("Sale Item");
...
$html="";
$title="Sale Item";
$html.= '<center><h1>LAPORAN SALE ITEM</h1></center>';
$html.= '<table border="1" cellpadding="5" cellspacing="0" width="100%">';
                $html.= "<tr>";
                $html.= "<td>Id</td>";
                $html.='<td>'.$saleItem['SaleItem']['id'].'</td>';
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Price</td>";
                $html.='<td>'.$saleItem['SaleItem']['price'].'</td>';
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Qty</td>";
                $html.='<td>'.$saleItem['SaleItem']['qty'].'</td>';
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Sale</td>";
                $html.='<td>'.$saleItem['SaleItem']['sale_id'].'</td>';
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Product</td>";
                $html.='<td>'.$saleItem['SaleItem']['product_id'].'</td>';
                $html.= "</tr>";
                $html.= "</table>";
    $html.= '<p></p><p></p>';
