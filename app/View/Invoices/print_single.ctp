...
$html="";
$title="Invoice";
$html.= '<center><h1>LAPORAN INVOICE</h1></center>';
$html.= '<table border="1" cellpadding="5" cellspacing="0" width="100%">';
                ...
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Date</td>";
                $html.='<td>'.$invoice['Invoice']['date'].'</td>';
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Amount</td>";
                $html.='<td>'.$invoice['Invoice']['amount'].'</td>';
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Description</td>";
                $html.='<td>'.$invoice['Invoice']['description'].'</td>';
                $html.= "</tr>";
                        $html.= "<tr>";
                $html.= "<td>Sale</td>";
                $html.='<td>'.$invoice['Invoice']['sale_id'].'</td>';
                $html.= "</tr>";
                $html.= "</table>";
    $html.= '<p></p><p></p>';
