 ...
 */
	Configure::write('debug', 0);        
        Configure::write('base_url','http://localhost/workshop-cake');
 ...
 */
	Configure::write('Security.salt', '30798cfd92a880bee3f1e31f53ec55247a6a31b4');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '176648815670532783237740313555');
