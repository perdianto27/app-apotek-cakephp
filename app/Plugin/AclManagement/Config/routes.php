<?php
//list user
Router::connect('/admin', array('plugin' => 'acl_management', 'controller' => 'users', 'action'=>'index'));
...
//logout
Router::connect('/admin/users/logout', array('plugin' => 'acl_management', 'controller' => 'users', 'action' => 'logout'));
