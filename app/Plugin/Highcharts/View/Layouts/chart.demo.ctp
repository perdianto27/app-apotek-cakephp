...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        echo $this->Html->script(array('/js/jquery-3.1.1.min.js', '/js/highcharts.src.js'));
    ...
    <body>
        <div id="container">
            ...
            <div id="footer">
                ...
                echo $this->Html->link
                        (
                        $this->Html->image('cake.power.gif', array('alt' => __("CakePHP: the rapid development php framework"), 'border' => "0")), 'http://www.cakephp.org/', array('target' => '_blank', 'escape' => false), false
                );
                ?>
            </div>
        </div>
